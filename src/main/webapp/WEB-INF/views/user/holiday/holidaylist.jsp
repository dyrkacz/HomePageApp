    ...
    <main>
        <div class="container-fluid px-4">
            <div class="card mb-4 mt-4">
                        ...
                        <div class="col">
                            <c:choose>
                                <c:when test="${empty param.status and empty param.search}">
                                    <ul class="nav nav-tabs card-header-tabs card-bottom">
                                        <li class="nav-item-dark">
                                            <a class="nav-link-dark active" id="activeHolidays"
                                               href="/user/holiday/list">Active
                                                holidays</a>
                                        </li>
                                        <li class="nav-item-dark">
                                            <a class="nav-link-dark" id="oldHolidays"
                                               href="/user/holiday/list?status=old">Old
                                                holidays</a>
                                        </li>
                                    </ul>
                                </c:when>
                                <c:when test="${param.status == 'old'}">
                                    <ul class="nav nav-tabs card-header-tabs card-bottom">
                                        <li class="nav-item-dark">
                                            <a class="nav-link-dark" id="activeHolidays" href="/user/holiday/list">Active
                                                holidays</a>
                                        </li>
                                        <li class="nav-item-dark">
                                            <a class="nav-link-dark active" id="oldHolidays"
                                               href="/user/holiday/list?status=old">Old
                                                holidays</a>
                                        </li>
                                    </ul>
                                ...
                                <c:when test="${not empty param.search}">
                                    <ul class="nav nav-tabs card-header-tabs card-bottom">
                                        ...
                                        <li class="nav-item-dark">
                                            <a class="nav-link-dark active disabled" id="searchHolidays"
                                               href="">Search
                                                holidays</a>
                                        </li>
                                    </ul>
                ...
                <div class="card-body scroll-holidays mt-n4">
                                ...
                                <div class="row">
                                    <div class="btn-group-sm" role="group">
                                        ...
                                        <button type="button" class="btn btn-danger btn-sm active"
                                                data-toggle="modal"
                                                data-target="#exampleModalCenter${holiday.id}" aria-pressed="true">
                                            Delete
                                        </button>

                                        <!-- Modal -->
                                        <div class="modal fade" id="exampleModalCenter${holiday.id}" tabindex="-1"
                                             role="dialog" aria-labelledby="exampleModalCenterTitle${holiday.id}"
                                             aria-hidden="true">
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    <div class="modal-header">
                                                        <h5 class="modal-title"
                                                            id="exampleModalCenterTitle${holiday.id}">Delete</h5>
                                                    ...
                                                    <div class="modal-footer">
                                                        <a type="button" class="btn btn-danger active"
                                                           aria-pressed="true"
                                                           href="/user/holiday/delete/${holiday.id}">Delete</a>
                                        ...
                                        <a class="btn btn-dark btn-sm active" role="button"
                                           aria-pressed="true"
                                           href="/user/holiday/edit/${holiday.id}">Edit</a>
                                    </div>
                                </div>
                            </div>
                        </div>
